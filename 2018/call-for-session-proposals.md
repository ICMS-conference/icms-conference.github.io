...
*   Send a call for abstracts to the potential speakers in the topic area of the session (see template in [tex-format](http://icms-conference.org/2018/ICMS_Extended_Abstract_2018.tex) or in [pdf-format](ICMS_Extended_Abstract_2018.pdf)).
